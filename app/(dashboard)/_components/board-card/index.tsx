...
import { useApiMutatation } from "@/hooks/use-api-mutation";
...
export const BoardCard = ({
  ...
  const { mutate: onFavourite, pending: pendingFavourite } = useApiMutatation(
    api.board.favourite
  );

  const { mutate: onUnfavourite, pending: pendingUnfavourite } =
    useApiMutatation(api.board.unfavourite);
